...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      if (user && user.token) {
        try {
          // Use GET with Authorization header
  ...
  // Handle display name: user.user.email if nested, or user.email, or fallback
  const displayName = user.user?.email || user.email || "User";
